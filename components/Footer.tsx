      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-20 mb-24">
          <div className="col-span-1 md:col-span-2">
            <Link to="/" className="flex items-center gap-3 mb-10 group">
              ...
              <div className="flex flex-col">
                <span className="text-3xl font-serif tracking-[0.2em] font-bold text-charcoal uppercase leading-tight">Shivaay Photography</span>
            ...
            <div className="flex gap-8">
              <a href="https://www.instagram.com/shivaay_photography_ptg/" className="text-gray-400 hover:text-luxury transition-colors"><Instagram className="w-5 h-5" /></a>
          ...
          <div>
            ...
            <div className="space-y-5 text-sm text-graphite font-light">
              <p className="leading-relaxed">Bus Stand, Pratapgarh 312605, Rajasthan</p>
              <p className="tracking-widest">+91 6378960233</p>
              <p className="border-b border-luxury/30 inline-block">contact@shivaay.com</p>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-200 pt-16 flex flex-col md:flex-row justify-between items-center gap-8">
          <p className="text-gray-400 text-[10px] uppercase tracking-[0.3em] font-medium">
            © 2026 Shivaay Photography Fine Art Photography. All Rights Reserved.
          </p>
        ...
        <div className="mt-8 text-center">
          <p className="text-gray-400 text-[10px] uppercase tracking-[0.3em] font-medium">
            Developed by{' '}
            <a 
              href="https://arthzone.vercel.app/" 
              target="_blank" 
              rel="noopener noreferrer"
              className="text-luxury hover:text-charcoal transition-colors"
            >
